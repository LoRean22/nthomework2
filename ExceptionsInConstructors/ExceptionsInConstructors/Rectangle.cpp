...
{
	if (angleA != 90) throw Except("”гол A не равен 90 градусов");
	if (angleB != 90) throw Except("”гол B не равен 90 градусов");
	if (angleC != 90) throw Except("”гол C не равен 90 градусов");
	if (angleD != 90) throw Except("”гол D не равен 90 градусов");
}
